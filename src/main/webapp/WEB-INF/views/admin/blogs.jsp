...
<div class="container">
    ...
    <h3>所有博客 <a href="${ctx}/admin/blogs/add" type="button" class="btn btn-primary btn-sm">添加</a></h3>
        ...
        <table class="table table-bordered table-striped">
            ...
            <c:forEach items="${blogList}" var="blog">
                <tr>
                    ...
                    <td>
                        <a href="${ctx}/admin/blogs/show/${blog.id}" type="button" class="btn btn-sm btn-success">详情</a>
                        <a href="${ctx}/admin/blogs/update/${blog.id}" type="button" class="btn btn-sm btn-warning">修改</a>
                        <a href="${ctx}/admin/blogs/delete/${blog.id}" type="button" class="btn btn-sm btn-danger">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
